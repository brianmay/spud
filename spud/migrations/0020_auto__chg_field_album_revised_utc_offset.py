...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'album.revised_utc_offset'
        db.alter_column(u'spud_album', 'revised_utc_offset', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'album.revised_utc_offset'
        db.alter_column(u'spud_album', 'revised_utc_offset', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 4, 11, 59, 25, 152724)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 4, 11, 59, 25, 152101)'}),
