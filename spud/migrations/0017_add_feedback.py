...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'feedback_ascendant'
        db.create_table(u'spud_feedback_ascendant', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ascendant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='descendant_set', to=orm['spud.feedback'])),
            ('descendant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ascendant_set', to=orm['spud.feedback'])),
            ('position', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'spud', ['feedback_ascendant'])

        # Adding model 'feedback'
        db.create_table(u'spud_feedback', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feedbacks', to=orm['spud.photo'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['spud.feedback'])),
            ('rating', self.gf('django.db.models.fields.IntegerField')()),
            ('comment', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='photos_feedbacks', null=True, to=orm['auth.User'])),
            ...
            ('submit_datetime', self.gf('django.db.models.fields.DateTimeField')()),
        ...
        db.send_create_signal(u'spud', ['feedback'])


    def backwards(self, orm):
        
        # Deleting model 'feedback_ascendant'
        db.delete_table(u'spud_feedback_ascendant')

        # Deleting model 'feedback'
        db.delete_table(u'spud_feedback')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 20, 15, 38, 56, 746874)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 20, 15, 38, 56, 746250)'}),
