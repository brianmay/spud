...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'photo.action'
        db.add_column(u'zoph_photos', 'action', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=4, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'photo.action'
        db.delete_column(u'zoph_photos', 'action')
