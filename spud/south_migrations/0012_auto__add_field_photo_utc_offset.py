...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'photo.utc_offset'
        db.add_column('spud_photo', 'utc_offset', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'photo.utc_offset'
        db.delete_column('spud_photo', 'utc_offset')
