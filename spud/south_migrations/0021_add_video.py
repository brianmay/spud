...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'photo_video'
        db.create_table(u'spud_photo_video', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['spud.photo'])),
            ('size', self.gf('django.db.models.fields.CharField')(max_length=10, db_index=True)),
        ...
        db.send_create_signal(u'spud', ['photo_video'])


    def backwards(self, orm):
        
        # Deleting model 'photo_video'
        db.delete_table(u'spud_photo_video')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 11, 11, 22, 35, 627934)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 11, 11, 22, 35, 627332)'}),
        ...
        u'spud.album': {
            ...
            'revised': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'revised_utc_offset': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
