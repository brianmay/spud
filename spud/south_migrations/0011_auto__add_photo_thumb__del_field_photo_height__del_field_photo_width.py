...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'photo_thumb'
        db.create_table('spud_photo_thumb', (
        ...
        db.send_create_signal('spud', ['photo_thumb'])

        # Deleting field 'photo.height'
        db.delete_column('spud_photo', 'height')

        # Deleting field 'photo.width'
        db.delete_column('spud_photo', 'width')
    
    
    def backwards(self, orm):
        
        # Deleting model 'photo_thumb'
        db.delete_table('spud_photo_thumb')

        # Adding field 'photo.height'
        db.add_column('spud_photo', 'height', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'photo.width'
        db.add_column('spud_photo', 'width', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
