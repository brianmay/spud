...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'album.revised_utc_offset'
        db.add_column(u'spud_album', 'revised_utc_offset', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'album.revised_utc_offset'
        db.delete_column(u'spud_album', 'revised_utc_offset')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 1, 9, 42, 35, 965747)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 1, 9, 42, 35, 964987)'}),
        ...
        u'spud.album': {
            ...
            'revised_utc_offset': ('django.db.models.fields.IntegerField', [], {}),
