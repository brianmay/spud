...
urlpatterns = patterns('',
    ...
    url(r'^album/$', 'spud.views.album_search_results', name='static_album_search_results'),
    url(r'^album/(?P<album_id>\d+)/$', 'spud.views.album_detail', name='static_album_detail'),
    url(r'^category/$', 'spud.views.category_search_results', name='static_category_search_results'),
    url(r'^category/(?P<category_id>\d+)/$', 'spud.views.category_detail', name='static_category_detail'),
    url(r'^place/$', 'spud.views.place_search_results', name='static_place_search_results'),
    url(r'^place/(?P<place_id>\d+)/$', 'spud.views.place_detail', name='static_place_detail'),
    url(r'^person/$', 'spud.views.person_search_results', name='static_person_search_results'),
    url(r'^person/(?P<person_id>\d+)/$', 'spud.views.person_detail', name='static_person_detail'),
    url(r'^feedback/$', 'spud.views.feedback_search_results', name='static_feedback_search_results'),
