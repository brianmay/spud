...
urlpatterns = patterns('',
    ...
    url(r'^a/feedback/form/$', 'spud.ajax.feedback_search_form', name='ajax_feedback_search_form'),
    url(r'^a/feedback/results/$', 'spud.ajax.feedback_search_results', name='ajax_feedback_search_results'),
    url(r'^a/feedback/(?P<feedback_id>\d+)/$', 'spud.ajax.feedback', name='ajax_feedback'),
    url(r'^a/feedback/add/$', 'spud.ajax.feedback_add', name='ajax_feedback_add'),
    url(r'^a/feedback/(?P<feedback_id>\d+)/delete/$', 'spud.ajax.feedback_delete', name='ajax_feedback_delete'),
    ...
    url(r'^login/$', 'spud.views.login', name='login'),
    url(r'^logout/$', 'spud.views.logout', name='logout'),
    url(r'^album/$', 'spud.views.album_search_results', name='album_search_results'),
    url(r'^album/(?P<album_id>\d+)/$', 'spud.views.album_detail', name='album_detail'),
    url(r'^category/$', 'spud.views.category_search_results', name='category_search_results'),
    url(r'^category/(?P<category_id>\d+)/$', 'spud.views.category_detail', name='category_detail'),
    url(r'^place/$', 'spud.views.place_search_results', name='place_search_results'),
    url(r'^place/(?P<place_id>\d+)/$', 'spud.views.place_detail', name='place_detail'),
    url(r'^person/$', 'spud.views.person_search_results', name='person_search_results'),
    url(r'^person/(?P<person_id>\d+)/$', 'spud.views.person_detail', name='person_detail'),
    url(r'^feedback/$', 'spud.views.feedback_search_results', name='feedback_search_results'),
    url(r'^feedback/(?P<feedback_id>\d+)/$', 'spud.views.feedback_detail', name='feedback_detail'),
    url(r'^photo/$', 'spud.views.photo_search_results', name='photo_search_results'),
    url(r'^photo/(?P<photo_id>\d+)/$', 'spud.views.photo_detail', name='photo_detail'),
    url(r'^upload/$', 'spud.views.upload', name='upload'),
