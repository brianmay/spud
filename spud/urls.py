...
urlpatterns = patterns('',
    ...
    url(r'^action/(?P<object_id>[A-Za-z0-9]+)/detail/(?P<number>\d+|random)/$', 'spud.views.action_photo_detail', name='action_photo_detail'),
    url(r'^action/(?P<object_id>[A-Za-z0-9]+)/edit/(?P<number>\d+|random)/$', 'spud.views.action_photo_edit', name='action_photo_edit'),
