...
urlpatterns = patterns('',
    ...
    url(r'^b/person/$', 'spud.static.person_search', name='static_person_search'),
    url(r'^b/person/results/$', 'spud.static.person_search_results', name='static_person_search_results'),
    url(r'^b/person/(?P<person_id>\d+)/$', 'spud.static.person_detail', name='static_person_detail'),
    url(r'^b/search/$', 'spud.static.search', name='static_search'),
    url(r'^b/search/results/$', 'spud.static.search_results', name='static_search_results'),
    url(r'^b/settings/$', 'spud.static.settings', name='static_settings'),
