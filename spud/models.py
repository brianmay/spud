...
class place_new(base_model):
    ...
    cover_photo = models.ForeignKey('photo_new', related_name='place_cover_of', null=True, blank=True)
...
class album_new(base_model):
    ...
    cover_photo = models.ForeignKey('photo_new', related_name='album_cover_of', null=True, blank=True)
...
class category_new(base_model):
    ...
    cover_photo = models.ForeignKey('photo_new', related_name='category_cover_of', null=True, blank=True)
    sortname = models.CharField(max_length=96, blank=True)
    sortorder = models.CharField(max_length=96, blank=True)
    class Meta:
...
class person_new(base_model):
    ...
    home = models.ForeignKey(place_new, null=True, blank=True, related_name="home_of")
    work = models.ForeignKey(place_new, null=True, blank=True, related_name="work_of")
    ...
    notes = models.TextField(blank=True)
    cover_photo = models.ForeignKey('photo_new', related_name='person_cover_of', null=True, blank=True)
...
class photo_new(base_model):
    ...
    photographer = models.ForeignKey(person_new, null=True, blank=True, related_name='photographed')
    location = models.ForeignKey(place_new, null=True, blank=True, related_name='photos')
    ...
    albums = models.ManyToManyField(album_new, through='photo_album_new', related_name='photos')
    categorys = models.ManyToManyField(category_new, through='photo_category_new', related_name='photos')
    persons = models.ManyToManyField(person_new, through='photo_person_new', related_name='photos')
    relations = models.ManyToManyField('self', through='photo_relation_new',symmetrical=False)
...
class photo_album_new(base_model):
    photo = models.ForeignKey(photo_new)
    album = models.ForeignKey(album_new)
    class Meta:
        db_table = u'zoph_photo_albums'

class photo_category_new(base_model):
    photo = models.ForeignKey(photo_new)
    category = models.ForeignKey(category_new)
    class Meta:
        db_table = u'zoph_photo_categories'

class photo_person_new(base_model):
    photo = models.ForeignKey(photo_new)
    person = models.ForeignKey(person_new)
    position = models.IntegerField(null=True, blank=True)
    class Meta:
        db_table = u'zoph_photo_people'
        ordering = [ 'position' ]

class photo_relation_new(base_model):
    photo_1 = models.ForeignKey(photo_new, db_column="photo_id_1", related_name="relations_1")
    photo_2 = models.ForeignKey(photo_new, db_column="photo_id_2", related_name="relations_2")
